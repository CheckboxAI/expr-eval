...
describe('Functions', function () {
  ...
  describe('if(p, t, f)', function () {
    ...
    it('if(1==1 || 2==1, 39, 0)', function () {
      assert.strictEqual(Parser.evaluate('if(1==1 || 2==1, 39, 0)'), 39);
    });

    it('if(1==1 || 1==2, -4 + 8, 0)', function () {
      assert.strictEqual(Parser.evaluate('if(1==1 || 1==2, -4 + 8, 0)'), 4);
    });
